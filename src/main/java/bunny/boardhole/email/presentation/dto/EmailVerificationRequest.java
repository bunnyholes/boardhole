...
public record EmailVerificationRequest(
        @NotBlank(message = "{user.validation.password.current.required}") @Schema(description = "본인 확인용 현재 패스워드", example = "CurrentPass123!", requiredMode = Schema.RequiredMode.REQUIRED) String currentPassword,
