...
public class BoardCommandService {
    ...
    public BoardResult create(@Valid CreateBoardCommand cmd) {
        ...
        User author = userRepository.findById(authorId)
                .orElseThrow(() -> new ResourceNotFoundException(MessageUtils.getMessageStatic("error.user.not-found.id", authorId)));
        ...
        log.info(MessageUtils.getMessageStatic("log.board.created", saved.getId(), saved.getTitle(), author.getUsername()));
    ...
    public BoardResult update(@Valid UpdateBoardCommand cmd) {
        ...
        log.info(MessageUtils.getMessageStatic("log.board.updated", saved.getId(), saved.getTitle(), saved.getAuthor().getUsername()));
        return boardMapper.toResult(saved);
    }
    ...
    public void delete(@NotNull @Positive Long id) {
        ...
        log.info(MessageUtils.getMessageStatic("log.board.deleted", id, authorUsername));
    }
    ...
    public void incrementViewCount(@Valid IncrementViewCountCommand cmd) {
        ...
        Board board = boardRepository.findById(boardId)
                .orElseThrow(() -> new ResourceNotFoundException(MessageUtils.getMessageStatic("error.board.not-found.id", boardId)));
        ...
        log.info(MessageUtils.getMessageStatic("log.board.view-count-increased", boardId, saved.getViewCount()));
    }
    ...
    private Board loadBoardOrThrow(Long id) {
        return boardRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException(MessageUtils.getMessageStatic("error.board.not-found.id", id)));
    }
