...
class ErrorHandlingIntegrationTest extends ControllerTestBase {
    ...
    void test_409_duplicate_username() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/signup")
                ...
                .andExpect(jsonPath("$.title").value(bunny.boardhole.shared.util.MessageUtils.get("exception.title.duplicate-username")))
    ...
    void test_403_forbidden_resource_owner() throws Exception {
        ...
        mockMvc.perform(put("/api/boards/" + boardId)
                ...
                .andExpect(jsonPath("$.code").value(bunny.boardhole.shared.constants.ErrorCode.FORBIDDEN.getCode()))
                .andDo(print());
    }
